...
class TerapeutaPacientesView(View):
    def get(self, request, *args, **kwargs):
        terapeuta_id = kwargs.get('id')
        terapeuta = Terapeuta.objects.get(id=terapeuta_id)
        pacientes = list(terapeuta.pacientes.values("id", "nome", "idade"))
        return JsonResponse({"terapeuta": terapeuta.nome, "pacientes": pacientes}, safe=False)
